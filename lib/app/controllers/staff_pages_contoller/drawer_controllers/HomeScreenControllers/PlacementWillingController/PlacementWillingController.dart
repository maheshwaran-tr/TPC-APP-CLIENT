...
class PlacementwillingController extends GetxController {
  ...
  PlacementwillingController({required this.staff}); // Currently selected section
  ...
  void fetchStudents() async {
    ...
    List<Student> deptStudents = await StudentRequests.getStudentsByDept(staff.deptId.toString());
    ...
    sections.value = students.map((student) => student.section??"NA").toSet().toList();
